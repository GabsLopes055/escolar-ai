import { CentralCustoDetailsComponent } from './pages/central-custo-details/central-custo-details.component';
...
import { CentralDeCustoSolicitacao, statusCentralCusto } from '../../../../models/central-de-custo.interface';
...
export class CentralCustoComponent {
  ...
  constructor(
    ...
    menuService.setSelected({icon: 'task_alt', label: 'Central de Custo', route: '/admin/aprovacoes', checked: true});
